...
---@type GrimfallFixes
local GrimfallFixes = QuestieLoader:ImportModule("GrimfallFixes")
...
do
    ...
    function QuestieCorrections:MinimalInit() -- db already compiled
        ...
        addOverride(QuestieDB.questDataOverrides, GrimfallFixes:LoadQuests())
        addOverride(QuestieDB.npcDataOverrides, GrimfallFixes:LoadNPCs())
        addOverride(QuestieDB.objectDataOverrides, GrimfallFixes:LoadObjects())
