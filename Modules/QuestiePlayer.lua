...
function QuestiePlayer:Initialize()
    ...
    if playerRaceId then
        ...
        -- Grimfall/custom race: allow all race-restricted quests
        playerRaceId = 0
        playerRaceFlag = 0xFFFFFFFF
        playerRaceFlagX2 = 0xFFFFFFFF
    end
    ...
    if classId then
        ...
        -- Grimfall/classless character: allow all class-restricted quests
        playerClassFlag = 0xFFFFFFFF
        playerClassFlagX2 = 0xFFFFFFFF
    end
end
